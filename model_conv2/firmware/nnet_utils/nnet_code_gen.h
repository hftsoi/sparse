...
class fill_buffer_2 : public FillConv2DBuffer<data_T, CONFIG_T> {
    ...
    static void fill_buffer(
        ...
        if (partition ==   1) {
            ...
            buffer[1][0] =          0; buffer[1][1] =          0; buffer[1][2] =          0; buffer[1][3] =    data[2]; buffer[1][4] =    data[3]; buffer[1][5] =    data[4]; buffer[1][6] =   data[12]; buffer[1][7] =   data[13]; buffer[1][8] =   data[14];
        ...
        if (partition ==   2) {
            ...
            buffer[1][0] =          0; buffer[1][1] =          0; buffer[1][2] =          0; buffer[1][3] =    data[4]; buffer[1][4] =    data[5]; buffer[1][5] =    data[6]; buffer[1][6] =   data[14]; buffer[1][7] =   data[15]; buffer[1][8] =   data[16];
        ...
        if (partition ==   3) {
            ...
            buffer[1][0] =          0; buffer[1][1] =          0; buffer[1][2] =          0; buffer[1][3] =    data[6]; buffer[1][4] =    data[7]; buffer[1][5] =    data[8]; buffer[1][6] =   data[16]; buffer[1][7] =   data[17]; buffer[1][8] =   data[18];
        ...
        if (partition ==   4) {
            ...
            buffer[1][0] =          0; buffer[1][1] =          0; buffer[1][2] =          0; buffer[1][3] =    data[8]; buffer[1][4] =    data[9]; buffer[1][5] =          0; buffer[1][6] =   data[18]; buffer[1][7] =   data[19]; buffer[1][8] =          0;
        ...
        if (partition ==   6) {
            ...
            buffer[1][0] =    data[2]; buffer[1][1] =    data[3]; buffer[1][2] =    data[4]; buffer[1][3] =   data[12]; buffer[1][4] =   data[13]; buffer[1][5] =   data[14]; buffer[1][6] =   data[22]; buffer[1][7] =   data[23]; buffer[1][8] =   data[24];
        ...
        if (partition ==   7) {
            ...
            buffer[1][0] =    data[4]; buffer[1][1] =    data[5]; buffer[1][2] =    data[6]; buffer[1][3] =   data[14]; buffer[1][4] =   data[15]; buffer[1][5] =   data[16]; buffer[1][6] =   data[24]; buffer[1][7] =   data[25]; buffer[1][8] =   data[26];
        ...
        if (partition ==   8) {
            ...
            buffer[1][0] =    data[6]; buffer[1][1] =    data[7]; buffer[1][2] =    data[8]; buffer[1][3] =   data[16]; buffer[1][4] =   data[17]; buffer[1][5] =   data[18]; buffer[1][6] =   data[26]; buffer[1][7] =   data[27]; buffer[1][8] =   data[28];
        ...
        if (partition ==   9) {
            ...
            buffer[1][0] =    data[8]; buffer[1][1] =    data[9]; buffer[1][2] =          0; buffer[1][3] =   data[18]; buffer[1][4] =   data[19]; buffer[1][5] =          0; buffer[1][6] =   data[28]; buffer[1][7] =   data[29]; buffer[1][8] =          0;
        ...
        if (partition ==  11) {
            ...
            buffer[1][0] =   data[12]; buffer[1][1] =   data[13]; buffer[1][2] =   data[14]; buffer[1][3] =   data[22]; buffer[1][4] =   data[23]; buffer[1][5] =   data[24]; buffer[1][6] =   data[32]; buffer[1][7] =   data[33]; buffer[1][8] =   data[34];
        ...
        if (partition ==  12) {
            ...
            buffer[1][0] =   data[14]; buffer[1][1] =   data[15]; buffer[1][2] =   data[16]; buffer[1][3] =   data[24]; buffer[1][4] =   data[25]; buffer[1][5] =   data[26]; buffer[1][6] =   data[34]; buffer[1][7] =   data[35]; buffer[1][8] =   data[36];
        ...
        if (partition ==  13) {
            ...
            buffer[1][0] =   data[16]; buffer[1][1] =   data[17]; buffer[1][2] =   data[18]; buffer[1][3] =   data[26]; buffer[1][4] =   data[27]; buffer[1][5] =   data[28]; buffer[1][6] =   data[36]; buffer[1][7] =   data[37]; buffer[1][8] =   data[38];
        ...
        if (partition ==  14) {
            ...
            buffer[1][0] =   data[18]; buffer[1][1] =   data[19]; buffer[1][2] =          0; buffer[1][3] =   data[28]; buffer[1][4] =   data[29]; buffer[1][5] =          0; buffer[1][6] =   data[38]; buffer[1][7] =   data[39]; buffer[1][8] =          0;
        ...
        if (partition ==  16) {
            ...
            buffer[1][0] =   data[22]; buffer[1][1] =   data[23]; buffer[1][2] =   data[24]; buffer[1][3] =   data[32]; buffer[1][4] =   data[33]; buffer[1][5] =   data[34]; buffer[1][6] =   data[42]; buffer[1][7] =   data[43]; buffer[1][8] =   data[44];
        ...
        if (partition ==  17) {
            ...
            buffer[1][0] =   data[24]; buffer[1][1] =   data[25]; buffer[1][2] =   data[26]; buffer[1][3] =   data[34]; buffer[1][4] =   data[35]; buffer[1][5] =   data[36]; buffer[1][6] =   data[44]; buffer[1][7] =   data[45]; buffer[1][8] =   data[46];
        ...
        if (partition ==  18) {
            ...
            buffer[1][0] =   data[26]; buffer[1][1] =   data[27]; buffer[1][2] =   data[28]; buffer[1][3] =   data[36]; buffer[1][4] =   data[37]; buffer[1][5] =   data[38]; buffer[1][6] =   data[46]; buffer[1][7] =   data[47]; buffer[1][8] =   data[48];
        ...
        if (partition ==  19) {
            ...
            buffer[1][0] =   data[28]; buffer[1][1] =   data[29]; buffer[1][2] =          0; buffer[1][3] =   data[38]; buffer[1][4] =   data[39]; buffer[1][5] =          0; buffer[1][6] =   data[48]; buffer[1][7] =   data[49]; buffer[1][8] =          0;
        ...
        if (partition ==  21) {
            ...
            buffer[1][0] =   data[32]; buffer[1][1] =   data[33]; buffer[1][2] =   data[34]; buffer[1][3] =   data[42]; buffer[1][4] =   data[43]; buffer[1][5] =   data[44]; buffer[1][6] =   data[52]; buffer[1][7] =   data[53]; buffer[1][8] =   data[54];
        ...
        if (partition ==  22) {
            ...
            buffer[1][0] =   data[34]; buffer[1][1] =   data[35]; buffer[1][2] =   data[36]; buffer[1][3] =   data[44]; buffer[1][4] =   data[45]; buffer[1][5] =   data[46]; buffer[1][6] =   data[54]; buffer[1][7] =   data[55]; buffer[1][8] =   data[56];
        ...
        if (partition ==  23) {
            ...
            buffer[1][0] =   data[36]; buffer[1][1] =   data[37]; buffer[1][2] =   data[38]; buffer[1][3] =   data[46]; buffer[1][4] =   data[47]; buffer[1][5] =   data[48]; buffer[1][6] =   data[56]; buffer[1][7] =   data[57]; buffer[1][8] =   data[58];
        ...
        if (partition ==  24) {
            ...
            buffer[1][0] =   data[38]; buffer[1][1] =   data[39]; buffer[1][2] =          0; buffer[1][3] =   data[48]; buffer[1][4] =   data[49]; buffer[1][5] =          0; buffer[1][6] =   data[58]; buffer[1][7] =   data[59]; buffer[1][8] =          0;
        ...
        if (partition ==  26) {
            ...
            buffer[1][0] =   data[42]; buffer[1][1] =   data[43]; buffer[1][2] =   data[44]; buffer[1][3] =   data[52]; buffer[1][4] =   data[53]; buffer[1][5] =   data[54]; buffer[1][6] =   data[62]; buffer[1][7] =   data[63]; buffer[1][8] =   data[64];
        ...
        if (partition ==  27) {
            ...
            buffer[1][0] =   data[44]; buffer[1][1] =   data[45]; buffer[1][2] =   data[46]; buffer[1][3] =   data[54]; buffer[1][4] =   data[55]; buffer[1][5] =   data[56]; buffer[1][6] =   data[64]; buffer[1][7] =   data[65]; buffer[1][8] =   data[66];
        ...
        if (partition ==  28) {
            ...
            buffer[1][0] =   data[46]; buffer[1][1] =   data[47]; buffer[1][2] =   data[48]; buffer[1][3] =   data[56]; buffer[1][4] =   data[57]; buffer[1][5] =   data[58]; buffer[1][6] =   data[66]; buffer[1][7] =   data[67]; buffer[1][8] =   data[68];
        ...
        if (partition ==  29) {
            ...
            buffer[1][0] =   data[48]; buffer[1][1] =   data[49]; buffer[1][2] =          0; buffer[1][3] =   data[58]; buffer[1][4] =   data[59]; buffer[1][5] =          0; buffer[1][6] =   data[68]; buffer[1][7] =   data[69]; buffer[1][8] =          0;
        ...
        if (partition ==  31) {
            ...
            buffer[1][0] =   data[52]; buffer[1][1] =   data[53]; buffer[1][2] =   data[54]; buffer[1][3] =   data[62]; buffer[1][4] =   data[63]; buffer[1][5] =   data[64]; buffer[1][6] =   data[72]; buffer[1][7] =   data[73]; buffer[1][8] =   data[74];
        ...
        if (partition ==  32) {
            ...
            buffer[1][0] =   data[54]; buffer[1][1] =   data[55]; buffer[1][2] =   data[56]; buffer[1][3] =   data[64]; buffer[1][4] =   data[65]; buffer[1][5] =   data[66]; buffer[1][6] =   data[74]; buffer[1][7] =   data[75]; buffer[1][8] =   data[76];
        ...
        if (partition ==  33) {
            ...
            buffer[1][0] =   data[56]; buffer[1][1] =   data[57]; buffer[1][2] =   data[58]; buffer[1][3] =   data[66]; buffer[1][4] =   data[67]; buffer[1][5] =   data[68]; buffer[1][6] =   data[76]; buffer[1][7] =   data[77]; buffer[1][8] =   data[78];
        ...
        if (partition ==  34) {
            ...
            buffer[1][0] =   data[58]; buffer[1][1] =   data[59]; buffer[1][2] =          0; buffer[1][3] =   data[68]; buffer[1][4] =   data[69]; buffer[1][5] =          0; buffer[1][6] =   data[78]; buffer[1][7] =   data[79]; buffer[1][8] =          0;
        ...
        if (partition ==  36) {
            ...
            buffer[1][0] =   data[62]; buffer[1][1] =   data[63]; buffer[1][2] =   data[64]; buffer[1][3] =   data[72]; buffer[1][4] =   data[73]; buffer[1][5] =   data[74]; buffer[1][6] =   data[82]; buffer[1][7] =   data[83]; buffer[1][8] =   data[84];
        ...
        if (partition ==  37) {
            ...
            buffer[1][0] =   data[64]; buffer[1][1] =   data[65]; buffer[1][2] =   data[66]; buffer[1][3] =   data[74]; buffer[1][4] =   data[75]; buffer[1][5] =   data[76]; buffer[1][6] =   data[84]; buffer[1][7] =   data[85]; buffer[1][8] =   data[86];
        ...
        if (partition ==  38) {
            ...
            buffer[1][0] =   data[66]; buffer[1][1] =   data[67]; buffer[1][2] =   data[68]; buffer[1][3] =   data[76]; buffer[1][4] =   data[77]; buffer[1][5] =   data[78]; buffer[1][6] =   data[86]; buffer[1][7] =   data[87]; buffer[1][8] =   data[88];
        ...
        if (partition ==  39) {
            ...
            buffer[1][0] =   data[68]; buffer[1][1] =   data[69]; buffer[1][2] =          0; buffer[1][3] =   data[78]; buffer[1][4] =   data[79]; buffer[1][5] =          0; buffer[1][6] =   data[88]; buffer[1][7] =   data[89]; buffer[1][8] =          0;
        ...
        if (partition ==  41) {
            ...
            buffer[1][0] =   data[72]; buffer[1][1] =   data[73]; buffer[1][2] =   data[74]; buffer[1][3] =   data[82]; buffer[1][4] =   data[83]; buffer[1][5] =   data[84]; buffer[1][6] =   data[92]; buffer[1][7] =   data[93]; buffer[1][8] =   data[94];
        ...
        if (partition ==  42) {
            ...
            buffer[1][0] =   data[74]; buffer[1][1] =   data[75]; buffer[1][2] =   data[76]; buffer[1][3] =   data[84]; buffer[1][4] =   data[85]; buffer[1][5] =   data[86]; buffer[1][6] =   data[94]; buffer[1][7] =   data[95]; buffer[1][8] =   data[96];
        ...
        if (partition ==  43) {
            ...
            buffer[1][0] =   data[76]; buffer[1][1] =   data[77]; buffer[1][2] =   data[78]; buffer[1][3] =   data[86]; buffer[1][4] =   data[87]; buffer[1][5] =   data[88]; buffer[1][6] =   data[96]; buffer[1][7] =   data[97]; buffer[1][8] =   data[98];
        ...
        if (partition ==  44) {
            ...
            buffer[1][0] =   data[78]; buffer[1][1] =   data[79]; buffer[1][2] =          0; buffer[1][3] =   data[88]; buffer[1][4] =   data[89]; buffer[1][5] =          0; buffer[1][6] =   data[98]; buffer[1][7] =   data[99]; buffer[1][8] =          0;
        ...
        if (partition ==  46) {
            ...
            buffer[1][0] =   data[82]; buffer[1][1] =   data[83]; buffer[1][2] =   data[84]; buffer[1][3] =   data[92]; buffer[1][4] =   data[93]; buffer[1][5] =   data[94]; buffer[1][6] =          0; buffer[1][7] =          0; buffer[1][8] =          0;
        ...
        if (partition ==  47) {
            ...
            buffer[1][0] =   data[84]; buffer[1][1] =   data[85]; buffer[1][2] =   data[86]; buffer[1][3] =   data[94]; buffer[1][4] =   data[95]; buffer[1][5] =   data[96]; buffer[1][6] =          0; buffer[1][7] =          0; buffer[1][8] =          0;
        ...
        if (partition ==  48) {
            ...
            buffer[1][0] =   data[86]; buffer[1][1] =   data[87]; buffer[1][2] =   data[88]; buffer[1][3] =   data[96]; buffer[1][4] =   data[97]; buffer[1][5] =   data[98]; buffer[1][6] =          0; buffer[1][7] =          0; buffer[1][8] =          0;
        ...
        if (partition ==  49) {
            ...
            buffer[1][0] =   data[88]; buffer[1][1] =   data[89]; buffer[1][2] =          0; buffer[1][3] =   data[98]; buffer[1][4] =   data[99]; buffer[1][5] =          0; buffer[1][6] =          0; buffer[1][7] =          0; buffer[1][8] =          0;
