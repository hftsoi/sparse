#ifndef NNET_CONV1D_MASK_H_
#define NNET_CONV1D_MASK_H_

#include "nnet_common.h"
#include "nnet_conv1d_mask_latency.h"
#include "nnet_conv1d_resource.h"
#include <cstdlib>

namespace nnet {

struct conv1d_mask_config {
...
void pointwise_conv_1d_mask_cl(data_T data[CONFIG_T::in_width * CONFIG_T::n_chan],
    ...
    if (CONFIG_T::strategy == nnet::latency) {
        conv_1d_mask_latency_cl<data_T, res_T, CONFIG_T>(data, mask, res, weights, biases);
    } else {
