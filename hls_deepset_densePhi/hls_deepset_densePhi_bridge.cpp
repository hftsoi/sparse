#ifndef HLS_DEEPSET_DENSEPHI_BRIDGE_H_
#define HLS_DEEPSET_DENSEPHI_BRIDGE_H_

#include "firmware/hls_deepset_densePhi.h"
...
void hls_deepset_densePhi_float(
    ...
    hls_deepset_densePhi(phi_input_ap,layer18_out_ap);

    nnet::convert_data<result_t, float, N_LAYER_16>(layer18_out_ap, layer18_out);
}

void hls_deepset_densePhi_double(
