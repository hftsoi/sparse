...
set DataType00 "[list ap_fixed 12 4 0 0 0 ]"
set Port00 [list $PortName00 $Interface00 $DataType00 $Pointer00 $Dims00 $Const00 $Volatile00 $ArrayOpt00]
lappend structMem0 $Port00
set DataType0tp1 "unsigned int"
set structParameter0 [list [list typename T] [list $DataType0tp1 N] ]
set DataType0ta0 "[list ap_fixed 12 4 0 0 0 ]"
set structArgument0 [list $DataType0ta0 3 ]
set SpaceName00 "nnet"
set NameSpace0 [list  [list  space $SpaceName00] ]
set structIsPacked0 "0"
set DataType0 [list "nnet::array<ap_fixed<12, 4, 0, 0, 0>, 3>" "struct array" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set structArgument1 [list $DataType1ta0 5 ]
set SpaceName10 "nnet"
set NameSpace1 [list  [list  space $SpaceName10] ]
set structIsPacked1 "0"
set DataType1 [list "nnet::array<ap_fixed<16, 6, 5, 3, 0>, 5>" "struct array" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
