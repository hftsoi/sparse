...
#define N_FILT_20 16
#define N_OUTPUTS_5 8
#define N_FILT_5 16
#define N_OUTPUTS_21 8
#define N_FILT_21 16
#define N_OUTPUTS_8 8
#define N_FILT_8 16
#define N_OUTPUTS_8 8
#define N_FILT_8 16
#define N_FILT_12 16
...
typedef nnet::array<ap_fixed<23,8>, 16*1> phi1_result_t;
typedef ap_fixed<8,1> weight19_t;
typedef ap_fixed<8,1> bias19_t;
typedef nnet::array<ap_ufixed<8,0,AP_RND_CONV,AP_SAT,0>, 16*1> layer4_t;
typedef ap_fixed<18,8> relu1_table_t;
typedef nnet::array<ap_fixed<21,6>, 16*1> phi2_result_t;
...
typedef nnet::array<ap_fixed<21,6>, 16*1> phi3_result_t;
typedef ap_fixed<8,1> weight21_t;
typedef ap_fixed<8,1> bias21_t;
typedef nnet::array<ap_ufixed<8,0,AP_RND_CONV,AP_SAT,0>, 16*1> layer10_t;
typedef ap_fixed<18,8> relu3_table_t;
typedef nnet::array<ap_fixed<20,11,AP_RND_CONV,AP_SAT,0>, 16*1> layer11_t;
typedef ap_fixed<18,8> act_agg_table_t;
typedef nnet::array<ap_fixed<16,6>, 16*1> layer12_t;
typedef nnet::array<ap_fixed<29,12>, 16*1> rho1_result_t;
typedef ap_fixed<8,1> weight13_t;
typedef ap_fixed<8,1> bias13_t;
typedef ap_uint<1> layer13_index;
typedef nnet::array<ap_ufixed<8,0,AP_RND_CONV,AP_SAT,0>, 16*1> layer15_t;
typedef ap_fixed<18,8> relu4_table_t;
typedef nnet::array<ap_fixed<21,6>, 5*1> rho2_result_t;
