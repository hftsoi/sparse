#ifndef HLS_DEEPSET_POINTWISEPHI_BRIDGE_H_
#define HLS_DEEPSET_POINTWISEPHI_BRIDGE_H_

#include "firmware/hls_deepset_pointwisePhi.h"
...
void hls_deepset_pointwisePhi_float(
    ...
    hls_deepset_pointwisePhi(phi_input_ap,layer18_out_ap);

    nnet::convert_data<result_t, float, N_LAYER_16>(layer18_out_ap, layer18_out);
}

void hls_deepset_pointwisePhi_double(
