...
`define AUTOTB_DUT      model_test
`define AUTOTB_DUT_INST AESL_inst_model_test
`define AUTOTB_TOP      apatb_model_test_top
`define AUTOTB_LAT_RESULT_FILE "model_test.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "model_test.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_model_test_top
...
`define AUTOTB_TVIN_x_in_out_wrapc  "../tv/rtldatafile/rtl.model_test.autotvin_x_in.dat"
...
`define AUTOTB_TVOUT_layer2_out_0_out_wrapc  "../tv/rtldatafile/rtl.model_test.autotvout_layer2_out_0.dat"
`define AUTOTB_TVOUT_layer2_out_1_out_wrapc  "../tv/rtldatafile/rtl.model_test.autotvout_layer2_out_1.dat"
`define AUTOTB_TVOUT_layer2_out_2_out_wrapc  "../tv/rtldatafile/rtl.model_test.autotvout_layer2_out_2.dat"
`define AUTOTB_TVOUT_layer2_out_3_out_wrapc  "../tv/rtldatafile/rtl.model_test.autotvout_layer2_out_3.dat"
`define AUTOTB_TVOUT_layer2_out_4_out_wrapc  "../tv/rtldatafile/rtl.model_test.autotvout_layer2_out_4.dat"
`define AUTOTB_TVOUT_layer2_out_5_out_wrapc  "../tv/rtldatafile/rtl.model_test.autotvout_layer2_out_5.dat"
`define AUTOTB_TVOUT_layer2_out_6_out_wrapc  "../tv/rtldatafile/rtl.model_test.autotvout_layer2_out_6.dat"
`define AUTOTB_TVOUT_layer2_out_7_out_wrapc  "../tv/rtldatafile/rtl.model_test.autotvout_layer2_out_7.dat"
`define AUTOTB_TVOUT_layer2_out_8_out_wrapc  "../tv/rtldatafile/rtl.model_test.autotvout_layer2_out_8.dat"
`define AUTOTB_TVOUT_layer2_out_9_out_wrapc  "../tv/rtldatafile/rtl.model_test.autotvout_layer2_out_9.dat"
module `AUTOTB_TOP;
...
wire ready_wire;
wire [1199 : 0] x_in;
wire [24 : 0] layer2_out_0;
wire [24 : 0] layer2_out_1;
wire [24 : 0] layer2_out_2;
wire [24 : 0] layer2_out_3;
wire [24 : 0] layer2_out_4;
wire [24 : 0] layer2_out_5;
wire [24 : 0] layer2_out_6;
wire [24 : 0] layer2_out_7;
wire [24 : 0] layer2_out_8;
wire [24 : 0] layer2_out_9;
wire  x_in_ap_vld;
wire ap_start;
...
reg AESL_REG_x_in_ap_vld;
// The signal of port x_in
reg [1199: 0] AESL_REG_x_in = 0;
assign x_in = AESL_REG_x_in;
assign x_in_ap_vld = AESL_REG_x_in_ap_vld;
initial begin : read_file_process_x_in
    integer fp;
    integer err;
    integer ret;
    integer proc_rand;
    ...
    transaction_idx = 0;
    AESL_REG_x_in_ap_vld <= 0;
    wait(AESL_reset === 0);
    fp = $fopen(`AUTOTB_TVIN_x_in,"r");
    if(fp == 0) begin       // Failed to open file
        $display("Failed to open file \"%s\"!", `AUTOTB_TVIN_x_in);
    ...
    while (token != "[[[/runtime]]]") begin
        ...
        if(token != "[[/transaction]]") begin
            AESL_REG_x_in_ap_vld <= 1;
            ret = $sscanf(token, "0x%x", AESL_REG_x_in);
              if (ret != 1) begin
...
reg [24: 0] AESL_REG_layer2_out_0 = 0;
...
reg [24: 0] AESL_REG_layer2_out_1 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
...
reg [24: 0] AESL_REG_layer2_out_2 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
...
reg [24: 0] AESL_REG_layer2_out_3 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
...
reg [24: 0] AESL_REG_layer2_out_4 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
...
reg [24: 0] AESL_REG_layer2_out_5 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
...
reg [24: 0] AESL_REG_layer2_out_6 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
...
reg [24: 0] AESL_REG_layer2_out_7 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
...
reg [24: 0] AESL_REG_layer2_out_8 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
...
reg [24: 0] AESL_REG_layer2_out_9 = 0;
always @(posedge AESL_clock)
begin
    if(AESL_reset)
