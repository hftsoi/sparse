...
if {[file isfile model_test.autotvin.dat]} {
	file delete -force model_test.autotvin.dat
}

if {[file isfile model_test.autotvout.dat]} {
	file delete -force model_test.autotvout.dat
}
