...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.model_test.autotvin_x_in.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.model_test.autotvout_layer2_out_0.dat"
         "rtl.model_test.autotvout_layer2_out_1.dat"
         "rtl.model_test.autotvout_layer2_out_2.dat"
         "rtl.model_test.autotvout_layer2_out_3.dat"
         "rtl.model_test.autotvout_layer2_out_4.dat"
         "rtl.model_test.autotvout_layer2_out_5.dat"
         "rtl.model_test.autotvout_layer2_out_6.dat"
         "rtl.model_test.autotvout_layer2_out_7.dat"
         "rtl.model_test.autotvout_layer2_out_8.dat"
         "rtl.model_test.autotvout_layer2_out_9.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
