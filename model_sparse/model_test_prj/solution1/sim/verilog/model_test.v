...
wire   [1199:0] entry_proc_U0_x_in_c_din;
wire    entry_proc_U0_x_in_c_write;
...
wire    sparse_input_U0_x_in_read;
...
wire    ap_channel_done_feat_arr_channel;
wire    feat_arr_channel_full_n;
reg    ap_sync_reg_channel_write_feat_arr_channel;
wire    ap_sync_channel_write_feat_arr_channel;
...
wire    ap_channel_done_hash_arr_channel;
wire    hash_arr_channel_full_n;
reg    ap_sync_reg_channel_write_hash_arr_channel;
wire    ap_sync_channel_write_hash_arr_channel;
...
wire   [2:0] x_in_c_fifo_cap;
wire    x_in_c_empty_n;
wire   [3:0] hash_arr_channel_dout;
wire   [1:0] hash_arr_channel_num_data_valid;
wire   [1:0] hash_arr_channel_fifo_cap;
wire    hash_arr_channel_empty_n;
...
wire   [11:0] feat_arr_channel_dout;
wire   [1:0] feat_arr_channel_num_data_valid;
wire   [1:0] feat_arr_channel_fifo_cap;
wire    feat_arr_channel_empty_n;
...
wire    start_for_sparse_input_U0_empty_n;
wire    ap_ce_reg;
...
#0 ap_sync_reg_channel_write_feat_arr_channel = 1'b0;
...
#0 ap_sync_reg_channel_write_hash_arr_channel = 1'b0;
end

model_test_entry_proc entry_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
model_test_fifo_w4_d2_S hash_arr_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
model_test_fifo_w12_d2_S feat_arr_channel_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_channel_write_feat_arr_channel <= 1'b0;
    end else begin
        if (((sparse_input_U0_ap_done & sparse_input_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_feat_arr_channel <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_channel_write_hash_arr_channel <= 1'b0;
    end else begin
        if (((sparse_input_U0_ap_done & sparse_input_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_hash_arr_channel <= 1'b0;
        end else begin
...
assign ap_channel_done_feat_arr_channel = (sparse_input_U0_ap_done & (ap_sync_reg_channel_write_feat_arr_channel ^ 1'b1));
...
assign ap_sync_channel_write_feat_arr_channel = ((feat_arr_channel_full_n & ap_channel_done_feat_arr_channel) | ap_sync_reg_channel_write_feat_arr_channel);
...
assign ap_sync_channel_write_hash_arr_channel = ((hash_arr_channel_full_n & ap_channel_done_hash_arr_channel) | ap_sync_reg_channel_write_hash_arr_channel);
...
assign sparse_input_U0_ap_continue = (ap_sync_channel_write_hash_arr_channel & ap_sync_channel_write_hash_arr_9 & ap_sync_channel_write_hash_arr_8 & ap_sync_channel_write_hash_arr_7 & ap_sync_channel_write_hash_arr_6 & ap_sync_channel_write_hash_arr_5 & ap_sync_channel_write_hash_arr_4 & ap_sync_channel_write_hash_arr_3 & ap_sync_channel_write_hash_arr_2 & ap_sync_channel_write_hash_arr_18 & ap_sync_channel_write_hash_arr_17 & ap_sync_channel_write_hash_arr_16 & ap_sync_channel_write_hash_arr_15 & ap_sync_channel_write_hash_arr_14 & ap_sync_channel_write_hash_arr_13 & ap_sync_channel_write_hash_arr_12 & ap_sync_channel_write_hash_arr_11 & ap_sync_channel_write_hash_arr_10 & ap_sync_channel_write_hash_arr_1 & ap_sync_channel_write_hash_arr & ap_sync_channel_write_feat_arr_channel & ap_sync_channel_write_feat_arr_8 & ap_sync_channel_write_feat_arr_7 & ap_sync_channel_write_feat_arr_6 & ap_sync_channel_write_feat_arr_5 & ap_sync_channel_write_feat_arr_4 & ap_sync_channel_write_feat_arr_3 & ap_sync_channel_write_feat_arr_2 & ap_sync_channel_write_feat_arr_1 
    & ap_sync_channel_write_feat_arr);

assign sparse_input_U0_ap_start = start_for_sparse_input_U0_empty_n;

assign start_for_sparse_input_U0_din = 1'b1;
