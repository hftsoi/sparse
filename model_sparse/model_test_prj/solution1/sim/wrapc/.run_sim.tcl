...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /tools/Xilinx/Vitis_HLS/2023.1/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/Xilinx/Vitis_HLS/2023.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/Xilinx/Vitis_HLS/2023.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/Xilinx/Vitis_HLS/2023.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "model_test.autotvin.dat"
	set constFileTvOut       "model_test.autotvout.dat"
	set constFileHdlTvIn     "model_test.autohdltvin.dat"
	set constFileHdlTvOut    "model_test.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
