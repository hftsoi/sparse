...
entity model_test_fifo_w1200_d3_A is
    generic (
        MEM_STYLE         : string  := "auto";
        DATA_WIDTH        : integer := 1200;
...
architecture arch of model_test_fifo_w1200_d3_A is

    -- component
    component model_test_fifo_w1200_d3_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
        DATA_WIDTH : natural := 1200;
...
begin
----------------------- Instantiation -----------------------
    U_model_test_fifo_w1200_d3_A_ram : model_test_fifo_w1200_d3_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity model_test_fifo_w1200_d3_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 1200;
        ADDR_WIDTH  : integer := 2;
...
architecture arch of model_test_fifo_w1200_d3_A_ram is
