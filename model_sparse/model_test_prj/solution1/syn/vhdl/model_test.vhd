...
architecture behav of model_test is 
    ...
    signal ap_channel_done_feat_arr_9 : STD_LOGIC;
    signal feat_arr_9_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_feat_arr_9 : STD_LOGIC := '0';
    signal ap_sync_channel_write_feat_arr_9 : STD_LOGIC;
    ...
    signal ap_channel_done_hash_arr_19 : STD_LOGIC;
    signal hash_arr_19_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_hash_arr_19 : STD_LOGIC := '0';
    signal ap_sync_channel_write_hash_arr_19 : STD_LOGIC;
    ...
    signal hash_arr_19_dout : STD_LOGIC_VECTOR (3 downto 0);
    signal hash_arr_19_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal hash_arr_19_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    signal hash_arr_19_empty_n : STD_LOGIC;
    ...
    signal feat_arr_9_dout : STD_LOGIC_VECTOR (11 downto 0);
    signal feat_arr_9_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal feat_arr_9_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    signal feat_arr_9_empty_n : STD_LOGIC;
...
begin
    ...
    hash_arr_19_U : component model_test_fifo_w4_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    feat_arr_9_U : component model_test_fifo_w12_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_channel_write_feat_arr_9_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_channel_write_feat_arr_9 <= ap_const_logic_0;
            else
                if (((sparse_input_U0_ap_done and sparse_input_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_feat_arr_9 <= ap_const_logic_0;
                else 
    ...
    ap_sync_reg_channel_write_hash_arr_19_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_channel_write_hash_arr_19 <= ap_const_logic_0;
            else
                if (((sparse_input_U0_ap_done and sparse_input_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_hash_arr_19 <= ap_const_logic_0;
                else 
    ...
    ap_channel_done_feat_arr_9 <= (sparse_input_U0_ap_done and (ap_sync_reg_channel_write_feat_arr_9 xor ap_const_logic_1));
    ...
    ap_channel_done_hash_arr_19 <= (sparse_input_U0_ap_done and (ap_sync_reg_channel_write_hash_arr_19 xor ap_const_logic_1));
    ...
    ap_done <= sparse_compute_U0_ap_done;
    ap_idle <= (sparse_input_U0_ap_idle and sparse_compute_U0_ap_idle and (feat_arr_9_empty_n xor ap_const_logic_1) and (feat_arr_8_empty_n xor ap_const_logic_1) and (feat_arr_7_empty_n xor ap_const_logic_1) and (feat_arr_6_empty_n xor ap_const_logic_1) and (feat_arr_5_empty_n xor ap_const_logic_1) and (feat_arr_4_empty_n xor ap_const_logic_1) and (feat_arr_3_empty_n xor ap_const_logic_1) and (feat_arr_2_empty_n xor ap_const_logic_1) and (feat_arr_1_empty_n xor ap_const_logic_1) and (feat_arr_empty_n xor ap_const_logic_1) and (hash_arr_19_empty_n xor ap_const_logic_1) and (hash_arr_18_empty_n xor ap_const_logic_1) and (hash_arr_17_empty_n xor ap_const_logic_1) and (hash_arr_16_empty_n xor ap_const_logic_1) and (hash_arr_15_empty_n xor ap_const_logic_1) and (hash_arr_14_empty_n xor ap_const_logic_1) and (hash_arr_13_empty_n xor ap_const_logic_1) and (hash_arr_12_empty_n xor ap_const_logic_1) and (hash_arr_11_empty_n xor ap_const_logic_1) and (hash_arr_10_empty_n xor ap_const_logic_1) and (hash_arr_9_empty_n xor ap_const_logic_1) 
    and (hash_arr_8_empty_n xor ap_const_logic_1) and (hash_arr_7_empty_n xor ap_const_logic_1) and (hash_arr_6_empty_n xor ap_const_logic_1) and (hash_arr_5_empty_n xor ap_const_logic_1) and (hash_arr_4_empty_n xor ap_const_logic_1) and (hash_arr_3_empty_n xor ap_const_logic_1) and (hash_arr_2_empty_n xor ap_const_logic_1) and (hash_arr_1_empty_n xor ap_const_logic_1) and (hash_arr_empty_n xor ap_const_logic_1));
    ap_ready <= sparse_input_U0_ap_ready;
    ...
    ap_sync_channel_write_feat_arr_9 <= ((feat_arr_9_full_n and ap_channel_done_feat_arr_9) or ap_sync_reg_channel_write_feat_arr_9);
    ...
    ap_sync_channel_write_hash_arr_19 <= ((hash_arr_19_full_n and ap_channel_done_hash_arr_19) or ap_sync_reg_channel_write_hash_arr_19);
    ...
    sparse_compute_U0_ap_start <= (hash_arr_empty_n and hash_arr_9_empty_n and hash_arr_8_empty_n and hash_arr_7_empty_n and hash_arr_6_empty_n and hash_arr_5_empty_n and hash_arr_4_empty_n and hash_arr_3_empty_n and hash_arr_2_empty_n and hash_arr_1_empty_n and hash_arr_19_empty_n and hash_arr_18_empty_n and hash_arr_17_empty_n and hash_arr_16_empty_n and hash_arr_15_empty_n and hash_arr_14_empty_n and hash_arr_13_empty_n and hash_arr_12_empty_n and hash_arr_11_empty_n and hash_arr_10_empty_n and feat_arr_empty_n and feat_arr_9_empty_n and feat_arr_8_empty_n and feat_arr_7_empty_n and feat_arr_6_empty_n and feat_arr_5_empty_n and feat_arr_4_empty_n and feat_arr_3_empty_n and feat_arr_2_empty_n and feat_arr_1_empty_n);
    sparse_input_U0_ap_continue <= (ap_sync_channel_write_hash_arr_9 and ap_sync_channel_write_hash_arr_8 and ap_sync_channel_write_hash_arr_7 and ap_sync_channel_write_hash_arr_6 and ap_sync_channel_write_hash_arr_5 and ap_sync_channel_write_hash_arr_4 and ap_sync_channel_write_hash_arr_3 and ap_sync_channel_write_hash_arr_2 and ap_sync_channel_write_hash_arr_19 and ap_sync_channel_write_hash_arr_18 and ap_sync_channel_write_hash_arr_17 and ap_sync_channel_write_hash_arr_16 and ap_sync_channel_write_hash_arr_15 and ap_sync_channel_write_hash_arr_14 and ap_sync_channel_write_hash_arr_13 and ap_sync_channel_write_hash_arr_12 and ap_sync_channel_write_hash_arr_11 and ap_sync_channel_write_hash_arr_10 and ap_sync_channel_write_hash_arr_1 and ap_sync_channel_write_hash_arr and ap_sync_channel_write_feat_arr_9 and ap_sync_channel_write_feat_arr_8 and ap_sync_channel_write_feat_arr_7 and ap_sync_channel_write_feat_arr_6 and ap_sync_channel_write_feat_arr_5 and ap_sync_channel_write_feat_arr_4 and ap_sync_channel_write_feat_arr_3 and ap_sync_channel_write_feat_arr_2 
