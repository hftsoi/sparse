...
struct config2 : nnet::conv2d_config {
    ...
    static const unsigned in_height = 50;
    ...
    static const unsigned min_height = 50;
    static const unsigned min_width = 40;
    static const ap_uint<filt_height * filt_width> pixels[min_height * min_width];
    static const unsigned n_partitions = 2000;
...
struct relu_config4 : nnet::activ_config {
    static const unsigned n_in = 2000;
...
struct config6 : nnet::conv2d_config {
    ...
    static const unsigned strategy = nnet::latency;
    static const nnet::conv_implementation implementation = nnet::conv_implementation::linebuffer;
    static const unsigned min_height = 25;
    static const unsigned min_width = 20;
    static const ap_uint<filt_height * filt_width> pixels[min_height * min_width];
    static const unsigned n_partitions = 500;
    static const unsigned n_pixels = out_height * out_width / n_partitions;
    template<class data_T, class CONFIG_T>
