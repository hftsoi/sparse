...
void hls_deepset_pointwisePhi_ioparallel::thread_hdltv_gen() {
    ...
    while (1) {
        ...
        mHdltvinHandle << mComma << "{"  <<  " \"phi_input_V\" :  \"" << phi_input_V.read() << "\" ";
        ...
        mHdltvinHandle << " , " <<  " \"phi_input_V_ap_vld\" :  \"" << phi_input_V_ap_vld.read() << "\" ";
