...
void hls_deepset_pointwisePhi_iostream(
    ...
    if (!loaded_weights) {
        nnet::load_weights_from_txt<weight19_t, 48>(w19, "w19.txt");
        ...
        nnet::load_weights_from_txt<weight21_t, 256>(w21, "w21.txt");
        ...
        nnet::load_weights_from_txt<weight16_t, 80>(w16, "w16.txt");
    ...
    #pragma HLS STREAM variable=layer19_out depth=8
